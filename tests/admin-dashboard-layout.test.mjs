...
test('dashboard summaries flow into a compact two-column workspace and preserve schedule editing', () => {
  ...
  assert.match(dashboard, /aria-label="Booking queue filters"/)
  assert.match(dashboard, /visibleBookings\.map/)
  assert.match(reporting, /bookings-pending/)
  assert.match(reporting, /bookings-unassigned/)
  assert.match(reporting, /bookings-inspections/)
})
