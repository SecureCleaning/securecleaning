...
const FAQ_DEFAULTS = [
  ...
  },
  {
    ...
    answer:
      'We currently operate in Melbourne and Sydney only. We cover metro and greater suburban areas in both cities. More cities will be added in the future.',
  },
  {
    question: 'How is pricing calculated?',
    answer:
      'Our pricing is based on your floor area, premises type, number of floors, cleaning frequency, time of day, and any add-ons you require. Use our instant online quote calculator to get a transparent price estimate in under 2 minutes — no waiting for a callback.',
  },
  {
    question: 'Is there a minimum contract period?',
    answer:
      "No. We don't believe in lock-in contracts. You stay because the service is excellent, not because you're trapped. We do ask for reasonable notice to cancel — typically 2 weeks for regular services.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. You're matched with a specific Owner-Operator who is responsible for your premises. You get their direct contact details. This continuity is one of the core advantages of the Owner-Operator model.",
  },
  {
    question: "What if I'm not happy with the service?",
    answer:
      "Contact your operator directly — they have a strong incentive to address any concerns immediately because their business reputation depends on it. If issues persist, contact us and we'll intervene. In rare cases where an operator match isn't working, we'll rematch you.",
  },
  {
    question: 'Do you bring your own cleaning products and equipment?',
    answer:
      "Yes. Owner-Operators supply all equipment and cleaning products. If you require specific products (e.g. environmentally certified, fragrance-free), let us know in your booking notes and we'll match you with an operator who can accommodate this.",
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. We offer after-hours (post 6pm weekdays) and weekend cleaning. Note that after-hours and weekend cleaning attracts a surcharge (25% and 50% respectively), which is reflected in your quote.',
  },
]
