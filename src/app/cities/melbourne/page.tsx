            ...
            <div className="space-y-6">
              ...
              <div className="bg-navy-50 rounded-2xl border p-6" style={{ borderColor: '#1a2744', backgroundColor: 'rgba(26,39,68,0.04)' }}>
                <p className="text-sm font-semibold mb-2" style={{ color: '#1a2744' }}>
                  {getContentValue(content, 'melbourne.chat_title', '🤖 Chat with Secure Bot')}
                </p>
                <p className="text-xs text-gray-600">
                  {getContentValue(content, 'melbourne.chat_body', 'Questions about Melbourne services? Secure Bot can help 24/7.')}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/booking"
              ...
              {getContentValue(content, 'melbourne.bottom_cta_secondary_label', 'Book Site Inspection')}
            </Link>
          </div>
        </div>
      </section>
