...
export default function ContractProductInterestForm({ productCode }: { productCode: string }) {
  ...
  if (status === 'done') return <p role="status" className="rounded-xl border border-green-200 bg-green-50 p-4 text-green-800">Thank you. Your interest has been received. Approved cleaners will receive a confirmation email; otherwise, the responsible agent will contact you.</p>
