...
export default function CleanerAccessAdmin() {
  ...
  async function send(event: React.FormEvent) {
    ...
    try {
      const response = await fetch('/api/admin/cleaner-access', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ email, mode }) })
