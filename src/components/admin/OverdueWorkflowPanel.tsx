          ...
          <div key={booking.booking_ref} className="px-6 py-4">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex flex-wrap gap-1">
                ...
                {!booking.assigned_operator_id && !booking.linkedOperatorId && !booking.inputs?.preferredInspectionAssigneeId ? <span className="rounded-full bg-white px-2 py-1 text-[11px] font-semibold text-amber-900">Missing operator</span> : null}
              </div>
            </div>
