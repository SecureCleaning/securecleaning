-- Apply after client_crm_missing_site_profile_migration.sql, before the optional-name UI.
-- Blank names remain empty strings; preserve existing NOT NULL columns and all access checks.
BEGIN;
