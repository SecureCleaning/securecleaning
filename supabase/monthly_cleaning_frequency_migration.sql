-- Secure Cleaning - add monthly recurring service frequency.
-- Apply after contract_product_saved_quote_won_migration.sql.

ALTER TYPE public.cleaning_frequency ADD VALUE IF NOT EXISTS 'monthly' BEFORE 'once_off';
...
BEGIN
  ...
  source_annual_visits := CASE source_frequency
    ...
    WHEN 'weekly' THEN 52 WHEN 'fortnightly' THEN 26 WHEN 'monthly' THEN 12
    WHEN 'once_off' THEN 1 ELSE 0 END;
